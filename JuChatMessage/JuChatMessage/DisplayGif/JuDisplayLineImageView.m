...
@interface JuDisplayLineImageView ()
{
    int tmp;
}
@property (nonatomic) NSUInteger currentFrameIndex;
@property (nonatomic,strong) JuDisplayLineImage *animatedImage;
...
@end
@implementation JuDisplayLineImageView
...
-(void)setImage:(UIImage *)image
{
    ...
    self.accumulator = 0;
    if ([image isKindOfClass:[JuDisplayLineImage class]] && image.images) {
        ...
        self.animatedImage = (JuDisplayLineImage *)image;
...
-(void)setAnimatedImage:(JuDisplayLineImage *)animatedImage
{
